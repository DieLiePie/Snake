...
class Snake():
    def __init__(self, snake_color):
        ...
        # звук съедания еды
        self.eat = pygame.mixer.Sound('eat.wav')
...
class Food():
    ...
    def draw_food(self, play_surface):
        ...
        if game.food_counter % 10 == 0 and game.food_counter != 0:
            pygame.draw.rect(
                play_surface, self.big_food_color, pygame.Rect(
                    self.food_pos[0], self.food_pos[1],
                    self.food_size_x, self.food_size_y))
            self.super_food = True
        else:
...
class Menu:
    def __init__(self, punkts=[120, 140, u'Punkt', (250, 250, 30), (250, 30, 250)]):
        ...
        # звук выбора одного из пунктов
        self.choose = pygame.mixer.Sound('choose.wav')
